...
async function inspectReport() {
  try {
    ...
    if (report.images) console.log("images:", JSON.stringify(report.images, null, 2));
    if (report.textMetrics) console.log("textMetrics:", JSON.stringify(report.textMetrics, null, 2));
